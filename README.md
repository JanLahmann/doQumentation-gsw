# doQumentation — Schwiizerdütsch

This is a deployment repository for [gsw.doqumentation.org](https://gsw.doqumentation.org), the Schwiizerdütsch version of [doQumentation](https://doqumentation.org).
